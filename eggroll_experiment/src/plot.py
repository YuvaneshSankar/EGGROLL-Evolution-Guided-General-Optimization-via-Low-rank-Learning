...
def plot_convergence_loglog(data, out_path, annotated=False, hw_label="RTX 3050, 4GB VRAM"):
    ...
    # Fitted line spans only the r values used in the fit.
    ...
    # Bias-only: solid for the r values used in the fit, dashed for the noise-floor regime.
    ...
    ax.set_title("EGGROLL gradient bias vs rank r")
    ...
    if annotated:
        txt = (
            ...
            f"{hw_label}\n"
            f"{cfg['matrix_size'][0]}×{cfg['matrix_size'][1]} W, σ={cfg['sigma']}\n"
